...
- 중복 신호 처리 방법
  - 추세 전환 후 지속 되는 추세를 계속 업데이트
  - 추세 전환 신호
    - 단기선(20)이 음수로 전환 또는 양수로 전환 된 경우
  - MACD와 시그널, 단기선이 둘다 음수 또는 양수인 경우 강한 매매 신호로 간주
  - 
- 거짓 신호 처리
  - 단기선 기울기 음수인 경우 다른 지표에서 매수 신호가 발생 하더라도 매도 신호 지속
  - 단기선 기굴기 양수인 경우 다른 지표에서 매도 신하고 발생 하다라도 매수 신호 지속
  - 
...
## 지표 계산
- ta를 사용한 지표를 계산하려면 dataframe을 사용해야함
